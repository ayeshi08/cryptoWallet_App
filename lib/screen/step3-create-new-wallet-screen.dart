...
import 'welcome-back-screen.dart';
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Image(image: AssetImage('assets/images/Group 7-2.png')),
              SizedBox(
                height: 40,
              ),
              Text(
                    ...
                    itemBuilder: (_, index) =>
                        Container(
                          ...
                          child: Center(child: Text('-----',style: TextStyle(
                              fontFamily:'Poppins-Bold' ,fontWeight:FontWeight.bold ,fontSize: 12,color: Color.fromRGBO(79, 79, 79, 1)
                          ),),),
                        ),
                    //FlutterLogo(),
