...
import 'third_create_new_wallet_screen.dart';

class CreateWalletSecondScreen extends StatefulWidget {
  const CreateWalletSecondScreen({super.key});

  @override
  State<CreateWalletSecondScreen> createState() =>
      _CreateWalletSecondScreenState();
}
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Image(image: AssetImage('assets/images/Group 7-1.png'),width: 274.w,height: 83.h,),
              10.verticalSpace,
              Text(
                     ...
                     // width: 70.w,height: 100.h,
                      ...
                      decoration: BoxDecoration(
                       color: AppColors.appMainColor,
                        border: Border.all(
                            color: AppColors.appSecondaryColor, width: 1.5.w),
                        borderRadius: BorderRadius.circular(5.r),
                      ),
                      child: Center(
                        child: Text(
                          SecretRecoveryPhraseItem[index]['text']!,
                          style: TextStyle(
                              fontFamily: 'Poppins',
                              fontWeight: FontWeight.w400,
                              fontSize: 12.sp,
